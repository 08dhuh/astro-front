...
const columnDefs = [
  ...
  { label: "Distance Modulus (V - Mv)", type: "input" },
  { label: "Distance D (parsecs)", type: "input" },
  { label: "Adjust (B - V)", type: "input" },
  { label: "Age (Gyr)", type: "input" },
  { label: "Metallicity", type: "input" },
];

export default function ClusterDataTable({ rows, setRows }) {
